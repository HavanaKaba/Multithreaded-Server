...
int main(int argc, char** argv) {
	...
	orderManager.validate(itemManager, std::cout); // Outputs all as unavailable
	
	// Validate the Tasks in each Item in Stock
	taskManager.validate(itemManager, std::cerr); // Needs to double check this, saying all items not available
